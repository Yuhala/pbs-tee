...
# Port descriptions
# op-geth http: 8547
# op-geth metrics: 6061
# op-node metrics: 7300
# el http: 8545
# el metrics: 9090

PORT_FORWARDS="-L 8547:127.0.0.1:8547 -L 6061:127.0.0.1:6061 -L 9090:127.0.0.1:9090 -L 7300:127.0.0.1:7300"
# ---------------------
...
echo "Ports: 8547, 6061, 9090 (forwarded to localhost on your machine)"
echo "-----------------------------"
