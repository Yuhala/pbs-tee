...
plot 'data/univ2_nopbs_tee_4vcpu_100_tps_tti.csv' u ($1-dx):3 t "4vcpu" with boxes ls 1 lc rgb C2 fillstyle pattern 3, \
    'data/univ2_nopbs_tee_8vcpu_100_tps_tti.csv' u ($1+dx):3 t "8vcpu"  with boxes ls 1 lc rgb C3 fillstyle pattern 2
...
plot 'data/univ2_nopbs_tee_4vcpu_100_tps_pending_tx.csv' u 1:3 every 2  w l ls 2006 notitle, \
      '' u 1:3 every 10 t "4vcpu" w lp ls 2006, \
     'data/univ2_nopbs_tee_8vcpu_100_tps_pending_tx.csv' u 1:3 every 2  w l ls 2007 notitle, \
     '' u 1:3 every 10 t "8vcpu" w lp ls 2007#, \
...
plot 'data/univ2_nopbs_tee_4vcpu_100_tps_gas_per_block.csv' u 1:3 every 2  w l ls 2006 notitle, \
      '' u 1:3 every 10 t "4vcpu" w lp ls 2006, \
     'data/univ2_nopbs_tee_8vcpu_100_tps_gas_per_block.csv' u 1:3 every 2  w l ls 2007 notitle, \
     '' u 1:3 every 10 t "8vcpu" w lp ls 2007#, \
...
plot 'data/univ2_nopbs_tee_4vcpu_100_tps_tx_gas_used.csv' u ($1-dx):3 t "4vcpu" with boxes ls 1 lc rgb C2 fillstyle pattern 3, \
     'data/univ2_nopbs_tee_8vcpu_100_tps_tx_gas_used.csv' u ($1+dx):3 t "8vcpu" with boxes ls 1 lc rgb C3 fillstyle pattern 2#, \
