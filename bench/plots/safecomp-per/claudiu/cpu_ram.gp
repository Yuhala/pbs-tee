...
plot 'data/no_pbs_no_tee/no-pbs_no-tee_30_sys_op-geth.csv' u 1:5 every 4  w l ls 2006 notitle, \
     ...
     'data/no_pbs_tee/no-pbs_tee_30_sys_op-geth.csv' u 1:5 every 4  w l ls 2007 notitle, \
     '' u 1:5 every 4 t "noPBS-TEE" w lp ls 2007, \
     'data/pbs_no_tee/pbs_geth_no-tee_30_sys_op-geth-ext.csv' u 1:5 every 4 w l ls 22004 notitle, \
     '' u 1:5 every 4 t "PBS-noTEE" w lp ls 22004,\
     'data/pbs_tee/pbs_geth_tee_30_sys_op-geth-ext.csv' u 1:5 every 4 w l ls 22001 notitle, \
     '' u 1:5 every 4 t "PBS-TEE" w lp ls 22001, \
     'data/pbs_no_tee/pbs_rbuilder_no-tee_30_sys_op-rbuilder.csv' u 1:5 every 4 w l ls 2002 notitle, \
     '' u 1:5 every 4 t "PBS-noTEE-rb" w lp ls 2002, \
     'data/pbs_tee/pbs_rbuilder_tee_30_sys_op-rbuilder.csv' u 1:5 every 4 w l ls 2004 notitle, \
     '' u 1:5 every 4 t "PBS-TEE-rb" w lp ls 2004
...
plot 'data/no_pbs_no_tee/no-pbs_no-tee_210_sys_op-geth.csv' u 1:5 every 4  w l ls 2006 notitle, \
     '' u 1:5 every 4 t "noPBS-noTEE" w lp ls 2006, \
     'data/no_pbs_tee/no-pbs_tee_210_sys_op-geth.csv' u 1:5 every 4  w l ls 2007 notitle, \
     '' u 1:5 every 4 t "noPBS-TEE" w lp ls 2007, \
     'data/pbs_no_tee/pbs_geth_no-tee_210_sys_op-geth-ext.csv' u 1:5 every 4 w l ls 22004 notitle, \
     '' u 1:5 every 4 t "PBS-noTEE" w lp ls 22004,\
     'data/pbs_tee/pbs_geth_tee_210_sys_op-geth-ext.csv' u 1:5 every 4 w l ls 22001 notitle, \
     '' u 1:5 every 4 t "PBS-TEE" w lp ls 22001, \
     'data/pbs_no_tee/pbs_rbuilder_no-tee_210_sys_op-rbuilder.csv' u 1:5 every 4 w l ls 2002 notitle, \
     '' u 1:5 every 4 t "PBS-noTEE-rb" w lp ls 2002, \
     'data/pbs_tee/pbs_rbuilder_tee_210_sys_op-rbuilder.csv' u 1:5 every 4 w l ls 2004 notitle, \
     '' u 1:5 every 4 t "PBS-TEE-rb" w lp ls 2004
     
!epstopdf "cpu_ram.eps"
!rm "cpu_ram.eps"
quit
