...
set ylabel "CPU" font ",16"  offset 4,0
...
plot 'data/no_pbs_no_tee/no-pbs_no-tee_270_sys_cpu_ram.csv' u 1:3 every 2  w l ls 2006 notitle, \
     '' u 1:3 every 10 t "noPBS-noTEE" w lp ls 2006, \
     'data/no_pbs_tee/no-pbs_tee_270_sys_cpu_ram.csv' u 1:3 every 2  w l ls 2007 notitle, \
     '' u 1:3 every 10 t "noPBS-TEE" w lp ls 2007, \
     'data/pbs_no_tee/pbs_rbuilder_no-tee_270_sys_cpu_ram.csv' u 1:3 every 2 w l ls 22004 notitle, \
     '' u 1:3 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/pbs_tee/pbs_rbuilder_tee_270_sys_cpu_ram.csv' u 1:3 every 2 w l ls 22001 notitle, \
