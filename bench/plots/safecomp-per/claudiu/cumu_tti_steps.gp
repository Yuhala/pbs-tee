...
plot 'data/no_pbs_no_tee/no-pbs_no-tee_30_tx_cumu_tti.csv' u 1:2 every 50  w steps ls 2006 notitle, \
     'data/no_pbs_tee/no-pbs_tee_30_tx_cumu_tti.csv' u 1:2 every 50  w steps ls 2007 notitle, \
     'data/pbs_no_tee/pbs_geth_no-tee_30_tx_cumu_tti.csv' u 1:2 every 50 w steps ls 22004 notitle, \
     'data/pbs_tee/pbs_geth_tee_30_tx_cumu_tti.csv' u 1:2 every 50 w steps ls 22001 notitle, \
     'data/pbs_no_tee/pbs_rbuilder_no-tee_30_tx_cumu_tti.csv' u 1:2 every 50 w steps ls 2002 notitle, \
     'data/pbs_tee/pbs_rbuilder_tee_30_tx_cumu_tti.csv' u 1:2 every 50 w steps ls 2004 notitle
...
plot 'data/no_pbs_no_tee/no-pbs_no-tee_210_tx_cumu_tti.csv' u 1:2 every 50  w steps ls 2006 notitle, \
     #'' u 1:2 every 300 t "noPBS-noTEE" w lp ls 2006, \
     'data/no_pbs_tee/no-pbs_tee_210_tx_cumu_tti.csv' u 1:2 every 50  w steps ls 2007 notitle, \
     #'' u 1:2 every 300 t "noPBS-TEE" w lp ls 2007, \
     'data/pbs_no_tee/pbs_geth_no-tee_210_tx_cumu_tti.csv' u 1:2 every 50 w steps ls 22004 notitle, \
     #'' u 1:2 every 300 t "PBS-noTEE" w lp ls 22004, \
     'data/pbs_tee/pbs_geth_tee_210_tx_cumu_tti.csv' u 1:2 every 50 w steps ls 22001 notitle, \
     #'' u 1:2 every 300 t "PBS-TEE" w lp ls 22001, \
     'data/pbs_no_tee/pbs_rbuilder_no-tee_210_tx_cumu_tti.csv' u 1:2 every 50 w steps ls 2002 notitle, \
     #'' u 1:2 every 300 t "PBS-noTEE-rb" w lp ls 2002, \
     'data/pbs_tee/pbs_rbuilder_tee_210_tx_cumu_tti.csv' u 1:2 every 50 w steps ls 2004 notitle, \
...
!epstopdf "cumu_tti_steps.eps"
!rm "cumu_tti_steps.eps"
quit
