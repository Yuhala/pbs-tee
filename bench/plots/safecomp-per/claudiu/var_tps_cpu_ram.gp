...
set output "var_tps_cpu_ram.eps"
...
set title "CPU usage: op-geth (30 TPS)" font "Helvetica-bold,14" #offset 0,-0.2
...
plot 'data/no_pbs_no_tee/no-pbs_no-tee_30_sys_cpu_ram.csv' u 1:3 every 1  w l ls 2006 notitle, \
     '' u 1:3 every 5 t "noPBS-noTEE" w lp ls 2006, \
     'data/no_pbs_tee/no-pbs_tee_30_sys_cpu_ram.csv' u 1:3 every 1  w l ls 2007 notitle, \
     '' u 1:3 every 5 t "noPBS-TEE" w lp ls 2007, \
     'data/pbs_no_tee/pbs_rbuilder_no-tee_30_sys_cpu_ram.csv' u 1:3 every 1 w l ls 22004 notitle, \
     '' u 1:3 every 5 t "PBS-noTEE" w lp ls 22004, \
     'data/pbs_tee/pbs_rbuilder_tee_30_sys_cpu_ram.csv' u 1:3 every 1 w l ls 22001 notitle, \
...
set yrange [0:800]
set title "RAM usage: op-geth (30 TPS)" font "Helvetica-bold,14" #offset 0,-0.2
...
plot 'data/no_pbs_no_tee/no-pbs_no-tee_30_sys_cpu_ram.csv' u 1:4 every 2  w l ls 2006 notitle, \
     '' u 1:4 every 5 t "noPBS-noTEE" w lp ls 2006, \
     'data/no_pbs_tee/no-pbs_tee_30_sys_cpu_ram.csv' u 1:4 every 2  w l ls 2007 notitle, \
     '' u 1:4 every 5 t "noPBS-TEE" w lp ls 2007, \
     'data/pbs_no_tee/pbs_rbuilder_no-tee_30_sys_cpu_ram.csv' u 1:4 every 2 w l ls 22004 notitle, \
     '' u 1:4 every 5 t "PBS-noTEE" w lp ls 22004, \
     'data/pbs_tee/pbs_rbuilder_tee_30_sys_cpu_ram.csv' u 1:4 every 2 w l ls 22001 notitle, \
...
set title "CPU usage: op-geth (270 TPS)" font "Helvetica-bold,14" #offset 0,-0.2
...
set yrange [0:1000]
set title "RAM usage: op-geth (270 TPS)" font "Helvetica-bold,14" #offset 0,-0.2

set ylabel "RAM usage (MB)" font ",16"  offset 4,0
set xlabel "Timestamp" font ",16" 
set xtics offset 0,0.4,0 font ",12"
...
!epstopdf "var_tps_cpu_ram.eps"
!rm "var_tps_cpu_ram.eps"
quit
