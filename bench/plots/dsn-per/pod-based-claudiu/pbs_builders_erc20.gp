...
set output "pbs_builders_erc20.eps"
...
plot 'data/erc20/pbs_notee_op-geth-erc20_gas_per_block.csv' u 1:3 every 2  w l ls 2006 notitle, \
      '' u 1:3 every 10 t "noTEE-op-geth" w lp ls 2006, \
     'data/erc20/pbs_tee_op-geth_erc20_gas_per_block.csv' u 1:3 every 2  w l ls 2007 notitle, \
...
plot 'data/erc20/pbs_notee_op-geth-erc20_tx_gas_used.csv' u ($1-dx):3 t "noTEE-op-geth" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
     'data/erc20/pbs_tee_op-geth_erc20_tx_gas_used.csv' u ($1+dx):3 t "TEE-op-geth" with boxes ls 1 lc rgb C3 fillstyle pattern 2, \
     'data/erc20/pbs_notee_op-rbuilder-erc20_tx_gas_used.csv' u ($1+3*dx):3 t "noTEE-op-rbuilder"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
     'data/erc20/pbs_tee_op-rbuilder_erc20_tx_gas_used.csv' u ($1+5*dx):3 t "TEE-op-rbuilder"  with boxes ls 1 lc rgb C5 fillstyle pattern 9

     
!epstopdf "pbs_builders_erc20.eps"
!rm "pbs_builders_erc20.eps"
quit
