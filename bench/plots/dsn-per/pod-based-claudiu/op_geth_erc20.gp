...
plot 'data/erc20/nopbs_notee_erc20_tti.csv' u ($1-dx):3 t "noPBS-noTEE" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
    ...
    'data/erc20/pbs_notee_op-geth-erc20_tti.csv' u ($1+3*dx):3 t "PBS-noTEE"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
    'data/erc20/pbs_tee_op-geth_erc20_tti.csv' u ($1+5*dx):3 t "PBS-TEE"  with boxes ls 1 lc rgb C5 fillstyle pattern 9
...
plot 'data/erc20/nopbs_notee_erc20_pending_tx_smoothed.csv' u 1:4 every 2  w l ls 2006 notitle, \
      '' u 1:4 every 10 t "noPBS-noTEE" w lp ls 2006, \
     'data/erc20/nopbs_tee_erc20_pending_tx_smoothed.csv' u 1:4 every 2  w l ls 2007 notitle, \
     '' u 1:4 every 10 t "noPBS-TEE" w lp ls 2007, \
     'data/erc20/pbs_notee_op-geth-erc20_pending_tx_smoothed.csv' u 1:4 every 2 w l ls 22004 notitle, \
     '' u 1:4 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/erc20/pbs_tee_op-geth_erc20_pending_tx_smoothed.csv' u 1:4 every 2 w l ls 22001 notitle, \
...
#unset key 
set ylabel "Gas used" font ",16"  offset 2.5,0
#set key samplen 1 maxrows 1 center top outside at graph 0.5, 1.0 font ",14"
...
plot 'data/erc20/nopbs_notee_erc20_gas_per_block.csv' u 1:3 every 2  w l ls 2006 notitle, \
     ...
     'data/erc20/pbs_notee_op-geth-erc20_gas_per_block.csv' u 1:3 every 2 w l ls 22004 notitle, \
     '' u 1:3 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/erc20/pbs_tee_op-geth_erc20_gas_per_block.csv' u 1:3 every 2 w l ls 22001 notitle, \
...
set xlabel "Gas used (x10k)" font ",16"
dx=0.05
...
plot 'data/erc20/nopbs_notee_erc20_tx_gas_used.csv' u ($1-dx):3 t "noPBS-noTEE" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
     ...
     'data/erc20/pbs_notee_op-geth-erc20_tx_gas_used.csv' u ($1+3*dx):3 t "PBS-noTEE"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
     'data/erc20/pbs_tee_op-geth_erc20_tx_gas_used.csv' u ($1+5*dx):3 t "PBS-TEE"  with boxes ls 1 lc rgb C5 fillstyle pattern 9

     
!epstopdf "op_geth_erc20.eps"
!rm "op_geth_erc20.eps"
quit
