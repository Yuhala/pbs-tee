...
plot 'data/stress/nopbs_notee_stress_tti.csv' u ($1-dx):3 t "noPBS-noTEE" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
    ...
    'data/stress/pbs_notee_op-geth-stress_tti.csv' u ($1+3*dx):3 t "PBS-noTEE"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
    'data/stress/pbs_tee_op-geth_stress_tti.csv' u ($1+5*dx):3 t "PBS-TEE"  with boxes ls 1 lc rgb C5 fillstyle pattern 9
...
plot 'data/stress/nopbs_notee_stress_pending_tx_smoothed.csv' u 1:4 every 2  w l ls 2006 notitle, \
      '' u 1:4 every 10 t "noPBS-noTEE" w lp ls 2006, \
     'data/stress/nopbs_tee_stress_pending_tx_smoothed.csv' u 1:4 every 2  w l ls 2007 notitle, \
     '' u 1:4 every 10 t "noPBS-TEE" w lp ls 2007, \
     'data/stress/pbs_notee_op-geth-stress_pending_tx_smoothed.csv' u 1:4 every 2 w l ls 22004 notitle, \
     '' u 1:4 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/stress/pbs_tee_op-geth_stress_pending_tx_smoothed.csv' u 1:4 every 2 w l ls 22001 notitle, \
...
plot 'data/stress/nopbs_notee_stress_gas_per_block.csv' u 1:3 every 2  w l ls 2006 notitle, \
     ...
     'data/stress/pbs_notee_op-geth-stress_gas_per_block.csv' u 1:3 every 2 w l ls 22004 notitle, \
     '' u 1:3 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/stress/pbs_tee_op-geth_stress_gas_per_block.csv' u 1:3 every 2 w l ls 22001 notitle, \
...
plot 'data/stress/nopbs_notee_stress_tx_gas_used.csv' u ($1-dx):3 t "noPBS-noTEE" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
     ...
     'data/stress/pbs_notee_op-geth-stress_tx_gas_used.csv' u ($1+3*dx):3 t "PBS-noTEE"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
     'data/stress/pbs_tee_op-geth_stress_tx_gas_used.csv' u ($1+5*dx):3 t "PBS-TEE"  with boxes ls 1 lc rgb C5 fillstyle pattern 9

     
!epstopdf "op_geth_stress.eps"
!rm "op_geth_stress.eps"
quit
