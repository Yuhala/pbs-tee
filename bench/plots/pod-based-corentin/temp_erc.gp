...
set output "op_geth_erc20_tps100.eps"
...
plot 'data/erc20/nopbs_notee_erc20_100_tps_tti.csv' u ($1-dx):3 t "noPBS-noTEE" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
    'data/erc20/nopbs_tee_erc20_100_tps_tti.csv' u ($1+dx):3 t "noPBS-TEE"  with boxes ls 1 lc rgb C3 fillstyle pattern 2, \
    'data/erc20/pbs_notee_erc20_100_tps_tti.csv' u ($1+3*dx):3 t "PBS-noTEE"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
    'data/erc20/pbs_tee_erc20_100_tps_tti.csv' u ($1+5*dx):3 t "PBS-TEE"  with boxes ls 1 lc rgb C5 fillstyle pattern 9
...
plot 'data/erc20/nopbs_notee_erc20_100_tps_pending_tx_smoothed.csv' u 1:4 every 2  w l ls 2006 notitle, \
      '' u 1:4 every 10 t "noPBS-noTEE" w lp ls 2006, \
     'data/erc20/nopbs_tee_erc20_100_tps_pending_tx_smoothed.csv' u 1:4 every 2  w l ls 2007 notitle, \
     '' u 1:4 every 10 t "noPBS-TEE" w lp ls 2007, \
     'data/erc20/pbs_notee_erc20_100_tps_pending_tx_smoothed.csv' u 1:4 every 2 w l ls 22004 notitle, \
     '' u 1:4 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/erc20/pbs_tee_erc20_100_tps_pending_tx_smoothed.csv' u 1:4 every 2 w l ls 22001 notitle, \
...
plot 'data/erc20/nopbs_notee_erc20_100_tps_gas_per_block.csv' u 1:3 every 2  w l ls 2006 notitle, \
      '' u 1:3 every 10 t "noPBS-noTEE" w lp ls 2006, \
     'data/erc20/nopbs_tee_erc20_100_tps_gas_per_block.csv' u 1:3 every 2  w l ls 2007 notitle, \
     '' u 1:3 every 10 t "noPBS-TEE" w lp ls 2007, \
     'data/erc20/pbs_notee_erc20_100_tps_gas_per_block.csv' u 1:3 every 2 w l ls 22004 notitle, \
     '' u 1:3 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/erc20/pbs_tee_erc20_100_tps_gas_per_block.csv' u 1:3 every 2 w l ls 22001 notitle, \
...
set xtics("0-2" 0, "2-4" 1) font ",12"
set ytics("2000" 2000, "4000" 4000, "6000" 6000, "8000" 8000, "10000" 10000) font ",12"
...
plot 'data/erc20/nopbs_notee_erc20_100_tps_tx_gas_used.csv' u ($1-dx):3 t "noPBS-noTEE" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
     'data/erc20/nopbs_tee_erc20_100_tps_tx_gas_used.csv' u ($1+dx):3 t "noPBS-TEE" with boxes ls 1 lc rgb C3 fillstyle pattern 2, \
     'data/erc20/pbs_notee_erc20_100_tps_tx_gas_used.csv' u ($1+3*dx):3 t "PBS-noTEE"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
     'data/erc20/pbs_tee_erc20_100_tps_tx_gas_used.csv' u ($1+5*dx):3 t "PBS-TEE"  with boxes ls 1 lc rgb C5 fillstyle pattern 9

     
!epstopdf "op_geth_erc20_tps100.eps"
!rm "op_geth_erc20_tps100.eps"
quit
