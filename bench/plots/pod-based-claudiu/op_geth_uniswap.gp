...
set output "op_geth_uniswap.eps"
...
plot 'data/uniswap/nopbs_notee_uniswap_tti.csv' u ($1-dx):3 t "noPBS-noTEE" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
    ...
    'data/uniswap/pbs_notee_op-geth-uniswap_tti.csv' u ($1+3*dx):3 t "PBS-noTEE"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
    'data/uniswap/pbs_tee_op-geth_uniswap_tti.csv' u ($1+5*dx):3 t "PBS-TEE"  with boxes ls 1 lc rgb C5 fillstyle pattern 9
...
plot 'data/uniswap/nopbs_notee_uniswap_gas_per_block.csv' u 1:3 every 2  w l ls 2006 notitle, \
     ...
     'data/uniswap/pbs_notee_op-geth-uniswap_gas_per_block.csv' u 1:3 every 2 w l ls 22004 notitle, \
     '' u 1:3 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/uniswap/pbs_tee_op-geth_uniswap_gas_per_block.csv' u 1:3 every 2 w l ls 22001 notitle, \
...
plot 'data/uniswap/nopbs_notee_uniswap_tx_gas_used.csv' u ($1-dx):3 t "noPBS-noTEE" with boxes ls 1 lc rgb C2 fillstyle pattern 4, \
     ...
     'data/uniswap/pbs_notee_op-geth-uniswap_tx_gas_used.csv' u ($1+3*dx):3 t "PBS-noTEE"  with boxes ls 1 lc rgb C1 fillstyle pattern 3, \
     'data/uniswap/pbs_tee_op-geth_uniswap_tx_gas_used.csv' u ($1+5*dx):3 t "PBS-TEE"  with boxes ls 1 lc rgb C5 fillstyle pattern 9

     
!epstopdf "op_geth_uniswap.eps"
!rm "op_geth_uniswap.eps"
quit
