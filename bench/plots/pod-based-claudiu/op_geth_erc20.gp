...
plot 'data/erc20/nopbs_notee_erc20_pending_tx.csv' u 1:3 every 2  w l ls 2006 notitle, \
     ...
     'data/erc20/pbs_notee_op-geth-erc20_pending_tx.csv' u 1:3 every 2 w l ls 22004 notitle, \
     '' u 1:3 every 10 t "PBS-noTEE" w lp ls 22004, \
     'data/erc20/pbs_tee_op-geth_erc20_pending_tx.csv' u 1:3 every 2 w l ls 22001 notitle, \
